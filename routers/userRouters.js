...
const cvUploadMulter = require('../middlewares/cvUploadMulter')
const {errorHandleUpload} = require('../middlewares/errorHandleUploadFile')
...
router.put('/cv-upload',
    authVerify,
    cvUploadMulter.single('cv'),
    errorHandleUpload,
    cvUpload
)
//problem
